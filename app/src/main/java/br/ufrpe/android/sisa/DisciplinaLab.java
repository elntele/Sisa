...
public class DisciplinaLab {
    ...
    private DisciplinaLab(Context appContext) {
        ...
        d4.setNome("Iniciação a Ciência da Computaçao");
        d4.setCursada(false);
        d4.setCodigo("4");
        mDisciplinas.add(d4);
        ...
        d11.setNome("Projeto e Analise de Algoritmos");
